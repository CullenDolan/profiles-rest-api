...
import os
from skeleton_keys import django_api_key
...
AUTH_USER_MODEL = 'profiles_api.UserProfile' # tell django to use a different authentication model besides the default
